RSpec.describe BankTerminal do
  ...
  context 'create account' do
    let(:commands) { ['create','Boris','45','thelogin','thepassword','exit'] }
  ...
  context 'load account' do
    let(:commands) { ['load','thelogin','thepassword','exit'] }
  ...
  context 'create first account' do
    let(:commands) { ['load','y','thelogin','thepassword','exit'] }
